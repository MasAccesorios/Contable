$json = [IO.File]::ReadAllText("test_sync_results.json")
$dbjs = [IO.File]::ReadAllText("js\db.js")
$scriptBlock = @"
...
[IO.File]::WriteAllText("js\db.js", $dbjs + "`n" + $scriptBlock, $utf8NoBom)
Write-Output "Inyeccion segura completada sin BOM."
